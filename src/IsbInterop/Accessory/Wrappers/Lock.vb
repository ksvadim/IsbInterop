...
#Region "Поля и свойства"
        ...
        Public ReadOnly Property Hostname() As String Implements ILock.Hostname
            Get
                Return DirectCast(Me.GetRcwProperty("Hostname"), String)
            End Get
        End Property
        ...
        Public ReadOnly Property Locked() As Boolean Implements ILock.Locked
            Get
                Return CBool(Me.GetRcwProperty("Locked"))
            End Get
        End Property
        ...
        Public ReadOnly Property SystemCode() As String Implements ILock.SystemCode
            Get
                Return DirectCast(Me.GetRcwProperty("SystemCode"), String)
            End Get
        End Property
        ...
        Public ReadOnly Property LockedByThis() As Boolean Implements ILock.LockedByThis
            Get
                Return CBool(Me.GetRcwProperty("LockedByThis"))
            End Get
        End Property
        ...
        Public ReadOnly Property LockTime() As DateTime Implements ILock.LockTime
            Get
                Return DirectCast(Me.GetRcwProperty("LockTime"), DateTime)
            End Get
        End Property
        ...
        Public ReadOnly Property ObjectId() As Integer Implements ILock.ObjectID
            Get
                Return CInt(Me.GetRcwProperty("ObjectID"))
            End Get
        End Property
        ...
        Public ReadOnly Property ObjectType() As TCompType Implements ILock.ObjectType
            Get
                Return DirectCast(Me.GetRcwProperty("ObjectType"), TCompType)
            End Get
        End Property
        ...
        Public ReadOnly Property UserName() As String Implements ILock.UserName
            Get
                Return DirectCast(Me.GetRcwProperty("UserName"), String)
            End Get
        End Property
...
#Region "Методы"
        ...
        Public Function LockObjectTimeout(milliseconds As Integer) As Boolean Implements ILock.LockObjectTimeout
            Dim result As Boolean = CBool(Me.InvokeRcwInstanceMethod("LockObjectTimeout", milliseconds))
            Return result
        End Function
        ...
        Public Function TryLockObject() As Boolean Implements ILock.TryLockObject
            Dim result As Boolean = CBool(Me.InvokeRcwInstanceMethod("TryLockObject"))
            Return result
        End Function
        ...
        Public Sub UnlockObject() Implements ILock.UnlockObject
            Me.InvokeRcwInstanceMethod("UnlockObject")
        End Sub
